...
public class ItemController {
    ...
    public ResponseEntity<PagedResources<ItemDTO>> getCustomersPage(int page, int size, PagedResourcesAssembler assembler){
        Page<ItemDTO> itemPage = itemService.getItemPage(page, size);
